...
- Images sent to the GPU worker are JPEG-encoded and resized to `LOCATE_MAX_REQUEST_SIDE=1600` by default to keep request bodies manageable; coordinates still render on the original image dimensions.
